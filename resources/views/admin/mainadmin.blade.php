    ...
    <div class="wrapper">
        ...
        <nav class="main-header navbar navbar-expand navbar-white navbar-light fixed-top">
            ...
            <ul class="navbar-nav">
                ...
                <li class="nav-item d-none d-sm-inline-block">
                    <a href="/admins" class="nav-link">Beranda</a>
                </li>
                <li class="nav-item d-none d-sm-inline-block">
            ...
            <ul class="navbar-nav ml-auto">
                ...
                <a class="nav-link" data-widget="control-sidebar" data-controlsidebar-slide="true" href="#"
                    role="button"></a> --}}
                <li class="nav-item">
                    <a class="nav-link" data-widget="#" data-toggle="dropdown" href="#" role="button">
        ...
        <aside class="main-sidebar sidebar-dark-primary elevation-4">
            ...
            <a href="index3.html" class="brand-link">
                ...
                <span class="brand-text font-weight-light">Huts Apparel</span>
            </a>
                ...
                <nav class="mt-2">
                    <ul class="nav nav-pills nav-sidebar flex-column" data-widget="treeview" role="menu"
                       ...
                       with font-awesome or any other icon font library -->
                        ...
                        <li class="nav-item menu-open">
                            <a href="/produk-adm" class="nav-link">
                        ...
                        <li class="nav-item menu-open">
                            <a href="/customadmin" class="nav-link">
                                <i class="nav-icon fas fa-tshirt"></i>
                                <p>
                                    Pesan Kaos
                                    <i class=""></i>
